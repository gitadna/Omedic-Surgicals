...
<head>
    ...
    <title>Hooks and Elevator - Plastic Surgery Instruments</title>
...
<body>
                            ...
                            <div class="glass-card p-3 h-100 d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <?php foreach ($product['attributes'] as $attr): ?>
                                        <h5 class="fw-bold text-dark mb-2">Length: <?= esc($attr['length']) ?></h5>
    ...
    <div class="modal fade-4" id="imageModal" tabindex="-1">
